const es = {
  ...
  form: {
    ...
    tipAlarmsRegimen: "Los días ya los define la frecuencia que elegiste — acá solo configurás el horario.",
    ...
    regimen_monthlyDay: "Mensual",
    regimenEveryPrefix: "Tomar cada",
    regimenEverySuffix: "días",
    regimenMonthDayPrefix: "El día",
    regimenMonthDaySuffix: "de cada mes",
    ...
    errorRegimenMonthDayMsg: "Ingresá un día del mes (entre 1 y 31).",
