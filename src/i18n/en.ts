...
const en: TranslationShape = {
  ...
  form: {
    ...
    tipAlarmsRegimen: "The days are already set by the frequency you chose — here you only set the time.",
    ...
    regimen_cycle: "Cycle",
    regimen_taper: "Taper",
    regimen_monthlyDay: "Monthly",
    regimenEveryPrefix: "Take every",
    regimenEverySuffix: "days",
    regimenMonthDayPrefix: "On day",
    regimenMonthDaySuffix: "of each month",
    ...
    errorRegimenMonthDayMsg: "Enter a day of the month (1 to 31).",
